...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{Non-inverting Schmitt trigger}: It is a comparator with positive feedback that produces two different switching thresholds.
            ...
            .\end{align*}
        \item \textbf{Linear circuit}: A linear circuit is an electrical system where the output voltage and current are directly proportional to the input, creating a straight-line graph
            \bigbreak \noindent 
            For example, if you double the input voltage, the output current also doubles.
        \item \textbf{Inverting Schmitt trigger}: An inverting Schmitt trigger is a comparator circuit with positive feedback. It converts a changing or noisy analog input into a clean HIGH or LOW output while using two different switching voltages.
            \bigbreak \noindent 
            ...
            \begin{align*}
                I = \frac{\Delta V}{R} = \frac{V_{\text{out}} - 0}{R_{1} + R_{2}} = V_{\text{out}}\frac{1}{R_{1}+R_{2}}
            .\end{align*}
            Notice that $V_{+} - 0 = IR_{2}$, so
            \begin{align*}
                V_{+} = V_{\text{out}}\frac{R_{2}}{R_{1} + R_{2}}
            .\end{align*}
            ...
            \begin{itemize}
                \item When \(V_{\text{in}}\) rises above the upper threshold \(V_{UT}\), the output switches from HIGH to LOW.
                \item When \(V_{\text{in}}\) falls below the lower threshold \(V_{LT}\), the output switches from LOW to HIGH.
            \end{itemize}
            This follows the comparator rule.
        \item \textbf{SR flip-flop}: The NOR implementation is the following
            \bigbreak \noindent 
            \fig{.6}{./figures/53.png}
            \bigbreak \noindent 
            So, 
            \begin{align*}
                Q_{n+1} &= \overline{R + \bar{Q_{n}}} = \bar{R}Q_{n}, \\
            ...
            \begin{center}
                \begin{tabularx}{\textwidth}{@{}XXXX@{}}
                    \toprule
                    \textbf{S} & \textbf{R} & $\mathbf{Q_{n}}$ & $\mathbf{Q_{n+1}}$ \\
                    \midrule
                    0 & 0 & 0& 0 \\[2ex]
                    0 & 0 & 1& 1\\[2ex]
                    0 & 1 & 0&  0\\[2ex]
            ...
            \begin{align*}
                \bar{S}\bar{R}Q_{n} + S\bar{R}\bar{Q} + S\bar{R}Q &= \bar{R}(\bar{S}Q + S\bar{Q} + SQ) \\
                &=\bar{R}(\bar{S}Q + S(\bar{Q} + Q)) = \bar{R}(\bar{S}Q  + S)
            .\end{align*}
            ...
            \begin{center}
                \begin{tabularx}{\textwidth}{@{}XXX@{}}
                    \toprule
                    \textbf{S} & \textbf{R}  & \textbf{Operation} \\
                    \midrule
                    0 & 0 & $Q_{n}$\\[2ex]
                    0 & 1 & 0\\[2ex]
                    1 & 0 & 1 \\[2ex]
            ...
            \end{center}
            \bigbreak \noindent 
            \textbf{Note:} This version corresponds to \textbf{active-high}, cross-coupled NOR SR latch.
            \bigbreak \noindent 
        ...
        \item \textbf{Nand version}: 
            \bigbreak \noindent 
            \fig{.6}{./figures/54.png}
            \bigbreak \noindent 
            Notice
            \begin{align*}
                Q &= \overline{\bar{S}\bar{Q}} = \bar{\bar{S}} + Q, \\
                \bar{Q} &= \overline{\bar{R}Q} = \bar{\bar{R}} + \bar{Q}
            .\end{align*}
            For the nand gate,
            \begin{align*}
            ...
            Thus, 
            \begin{align*}
                Q_{n+1} &= \bar{\bar{S}}\bar{R}\bar{Q} + \bar{\bar{S}}\bar{R}Q_{n} + \bar{S}\bar{R}Q_{n} = \bar{R}(\bar{\bar{S}}\bar{Q}_{n} + \bar{\bar{S}}Q_{n} + \bar{S}Q_{n}) \\
                &=\bar{R}(\bar{\bar{S}}\bar{Q}_{n} + Q_{n}(\bar{\bar{S}}) + \bar{S})  = \bar{R}(\bar{\bar{S}}\bar{Q}_{n} + Q_{n}) \\
                &=\bar{R}((Q_{n} + \bar{Q}_{n})(Q_{n} + \bar{\bar{S}})) = \bar{R}(\bar{\bar{S}} + Q_{n}) \\
                &=\bar{\bar{S}}\bar{R} + \bar{R}Q_{n}
            .\end{align*}
            Notice that since the condition is 
            \begin{align*}
                \bar{S} + \bar{R} = 1
            ,\end{align*}
            when $\bar{S} = 0$, $\bar{R}$ is forced to $1$. Thus, for $\bar{\bar{S}}\bar{R}$, when $S = 0$, $\bar{\bar{S}}\bar{R} = 1$, and when $S = 1$, $\bar{\bar{S}}\bar{R} = 0$. Hence, $\bar{\bar{S}}\bar{R} = \bar{\bar{S}} $ under the condition.
            \bigbreak \noindent 
            Therefore, the characteristic equation is 
            \begin{align*}
                \bar{\bar{S}} + \bar{R}Q_{n}
            .\end{align*}
            We have
            \begin{center}
                \begin{tabularx}{\textwidth}{@{}XXX@{}}
                ...
                \end{tabularx}
            \end{center}
        \item \textbf{Latch}: A latch is a circuit that can store one bit of information:
            \begin{align*}
        ...
        \item \textbf{RC circuit}: An RC circuit is an electrical circuit made of a resistor (R) and a capacitor (C) connected together
            \begin{itemize}
                \item A resistor \(R\), which limits current.
                \item A capacitor \(C\), which stores electrical charge and energy.
            \end{itemize}
