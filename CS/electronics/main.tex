...
\begin{document}
    ...
    \begin{itemize}  
        ...
        \item \textbf{Charge neutrality (electroneutrality)}: Charge neutrality means that a macroscopic object or material has an equal amount of positive and negative charge, resulting in a net electric charge of zero
            ...
            .\end{align*}
            It states that the net charge density (\(\rho _{net}\)) is equal to zero because the positive charge density (ρ₊) and the negative charge density (ρ₋) perfectly balance each other out.
