...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{Creating constants with typeglob}: You can generate read-only variables by assigning a reference to a constant value inside a typeglob.
            ...
            \end{perlcode}
        \item \textbf{Legacy filehandles}: In older Perl code, typeglobs or references to typeglobs (\texbackslash *FH) were required to pass filehandles into subroutines. Modern Perl handles this automatically via lexical scalar filehandles (open my \$fh, ...).
