...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{END}: END \{\} block in Perl runs code automatically just before the Perl interpreter exits the program.
            ...
            \end{itemize}
        \item \textbf{\_\_DATA\_\_}: __DATA__ token tells the compiler that the compilation of executable code is finished. Everything written below this token is treated as data, which Perl automatically makes accessible to your program through a special, built-in filehandle named DATA.
            \bigbreak \noindent 
            \begin{perlcode}
                use strict;
                use warnings;
    ...
    \begin{itemize}
        ...
        \item \textbf{Eskimo greeting}: Count the lines in a file:
            \bigbreak \noindent 
            \begin{perlcode}
                perl -lne '}{ print $.'
            \end{perlcode}
