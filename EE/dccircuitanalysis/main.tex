...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{Internal resistance}: A highly precise model for any voltage source or current source could be fairly complex but for general purpose work, we can greatly improve our ideal sources by simply adding a resistor to them. This resistance is referred to as the internal resistance of the source.
            \bigbreak \noindent 
